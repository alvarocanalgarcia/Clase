...
public class TestsMatriculaPorCurso {

	

	@Test
	public void testCompareAsignatura() {	
		MatriculaPorCurso apc = new MatriculaPorCurso();
		...
		Matricula m2 = new Matricula(a2, est1, Curso.C1718,OrdenMatricula.M3,21.21);
		Matricula m3 = new Matricula(a3, est1, Curso.C1819,OrdenMatricula.M3,21.21);
		Matricula m4 = new Matricula(a4, est1, Curso.C1617,OrdenMatricula.M3,21.21);
		
		
		assertTrue("matricula POO es menor que IA", apc.compare(m1,m3)<0);
		assertTrue("matricula POO es igual que TP2", apc.compare(m1,m4)==0);
		assertTrue("IA es mayor que TP1", apc.compare(m3,m2)>0);
