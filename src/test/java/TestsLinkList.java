...
public class TestsLinkList {

	@Test
	public void testConstructor() {
		LinkList<Integer> al = new LinkList<Integer>();	
	...
	public void testRemove() {
		LinkList<Double> al = new LinkList<Double>();
		for(int j=0;j<4;j++) {
		for(int i=0;i<250;i++) {
	...
	public void testGetSet() {
		LinkList<Integer> al = new LinkList<>();
		for(int i=0;i<50;i++) {
			al.add(i);
		}
	...
	public void testRemoveIndex() {
		LinkList<Double> al = new LinkList<>();
		for(int i=0;i<100;i++) {
			al.add(Double.parseDouble(""+i));
		}
	...
	public void testEqual() {
		...
		LinkList<Double> al2 = new LinkList<>();
		for(int i=0;i<5;i++) {
		...
		LinkList<Double> al3 = new LinkList<>();
		for(int i=4;i>=0;i--) {
	...
	public void testSubList() {
		...
		LinkList<Double> al1 = new LinkList<>();
		for(int i=0;i<10;i++) {
